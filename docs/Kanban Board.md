...
%% kanban:settings
```
{"kanban-plugin":"board","list-collapse":[false,false,false,false,false],"new-note-folder":"01 - Projects/004 - Programming/MeinErstesGame/Issues","tag-action":"kanban","tag-colors":[{"tagKey":"#Phase-0","color":"","backgroundColor":"rgba(93, 245, 94, 0.1)"}],"show-checkboxes":false}
```
%%